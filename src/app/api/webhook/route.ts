  ...
  try {
    ...
    if (isIncoming || isOutgoing) {
      ...
      const authInstructions = `
        ...
        ${isNewContact ? `- **לקוח/מספר חדש — תפריט ברוך הבא (חובה)**: זוהי הפנייה הראשונה. תשובתך חייבת לכלול בדיוק את הסדר הבא:\n  (א) הצגה: \"שלום${senderName ? ' ' + senderName : ''}, אני רותם, הנציגה הדיגיטלית של איי קיי חברת ניקיון ואחזקה 🧹\"\n  (ב) אם כבר שאלו שאלה ספציפית — ענה עליה בקצרה.\n  (ג) סיום בתפריט סיווג:\n  \"כדי שאוכל לעזור לך בצורה הטובה ביותר, ספר/י לי מי את/ה:\n  1️⃣ לקוח/ה קיים/ת — שאלה, שינוי או בקשה\n  2️⃣ לקוח/ה חדש/ה — מחיר, מידע על שירותים\n  3️⃣ אחר — ספק, שיתוף פעולה או נושא אחר\"` : ''}
      `;
