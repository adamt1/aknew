  ...
  try {
    ...
    if (isIncoming || isOutgoing) {
      ...
      const authInstructions = `
        ...
        ${isNewContact ? `- **מספר חדש — קראי את ההודעה לפני הכל**: זוהי הפנייה הראשונה. **אל תשלחי אוטומטית תפריט פתיחה.** קודם כל הבני את ההקשר:\n  • אם ההודעה היא מ**שליח / קורייר / חברת משלוחים** (מזכיר חבילה, משלוח, כתובת, קומה, קוד דלת, דלת) — ענה ישירות על הבקשה הלוגיסטית בלבד. ללא הצגה עצמית, ללא תפריט.\n  • אם ההודעה היא **פנייה עסקית אמיתית** (שירות ניקיון, מחיר, בעיה, שאלה על החברה) — הציגי את עצמך ואחר כך הצגת תפריט:\n  \\"שלום, אני רותם, הנציגה הדיגיטלית של איי קיי חברת ניקיון ואחזקה 🧹\\"\n  \\"כדי שאוכל לעזור לך בצורה הטובה ביותר, ספר/י לי מי את/ה:\n  1️⃣ לקוח/ה קיים/ת — שאלה, שינוי או בקשה\n  2️⃣ לקוח/ה חדש/ה — מחיר, מידע על שירותים\n  3️⃣ אחר — ספק, שיתוף פעולה או נושא אחר\\"\n  • בכל מקרה אחר (הודעה שגויה, ספאם, אישורים) — ענה בטבעיות בלי תפריט.` : ''}
      `;
